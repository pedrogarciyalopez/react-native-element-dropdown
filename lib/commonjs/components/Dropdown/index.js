  ...
  const _renderModal = (0, _react.useCallback)(() => {
    if (visible && position) {
      ...
      if (width && top && bottom) {
        ...
        return /*#__PURE__*/_react.default.createElement(ModalComponent, {
          transparent: true,
    ...
    return null;
  }, [ModalComponent, visible, search, position, keyboardHeight, maxHeight, minHeight, dropdownPosition, keyboardAvoiding, showOrClose, styleContainerVertical, backgroundColor, containerStyle, styleHorizontal, _renderList]);
